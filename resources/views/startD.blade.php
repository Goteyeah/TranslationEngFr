...
<section class="p-4">
  <div class="min-h-[50vh] bg-blue-500 rounded-xl  px-8 py-24">
    <div class="container mx-auto text-center">
      <p class="block antialiased font-sans text-sm leading-normal mb-4 font-medium text-white/70"></p>
      <h2 class="block antialiased tracking-normal font-sans text-4xl font-semibold leading-[1.3] text-white mb-4">Quick English Dictionary</h2>
      <p class="block antialiased font-sans text-xl font-normal leading-relaxed text-white mb-8 opacity-70">Choose the right plan for your legal needs</p>
    </div>
  </div>
  <div class="px-8 pt-8 pb-16 -mt-32">
        ...
        <div class="p-6 text-center">
          ...
          <ul class="flex flex-col gap-3 pt-6 my-6">
            ...
            <li class="flex items-center gap-2 text-gray-700"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" data-slot="icon" class="w-5 h-5 text-inherit">
              ...
              <p class="block antialiased font-sans text-base leading-relaxed font-normal text-inherit">contract review</p>
            </li>
            <li class="flex items-center gap-2 text-gray-700"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" data-slot="icon" class="w-5 h-5 text-inherit">
                <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"></path>
              </svg>
              <p class="block antialiased font-sans text-base leading-relaxed font-normal text-inherit">and more</p>
            </li>
          </ul><button class="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg bg-gradient-to-tr from-gray-900 to-gray-800 text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] w-full flex items-center justify-center gap-4" type="button">join <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" data-slot="icon" class="w-5 h-5">
        ...
        <div class="p-6 text-center">
          ...
          <ul class="flex flex-col gap-3 pt-6 my-6">
            ...
            <li class="flex items-center gap-2 text-gray-700"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" data-slot="icon" class="w-5 h-5 text-inherit">
              ...
              <p class="block antialiased font-sans text-base leading-relaxed font-normal text-inherit">contract drafting</p>
            </li>
            <li class="flex items-center gap-2 text-gray-700"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" data-slot="icon" class="w-5 h-5 text-inherit">
                <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"></path>
              </svg>
...
<div class="w-screen max-w-lg bg-amber-200 mx-auto mt-6 p-2">
    <div class="flex space-x-2">
      ...
      <p class="text-amber-900 font-semibold">Project is missing Contact Page</p>
    </div>
    <p class="ml-8 text-amber-800">Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem impedit possimus voluptatem dicta libero?</p>
  </div>
...
<h1>separation</h1>
  ...
  <div class="w-screen max-w-lg bg-red-200 mx-auto mt-6 p-2">
    <div class="flex space-x-2">
      ...
      <p class="text-red-900 font-semibold">Blogs are not being fetched</p>
    </div>
    <p class="ml-8 text-red-800">Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem impedit possimus voluptatem dicta libero?</p>
  </div>
  <div class="w-screen max-w-lg bg-green-200 mx-auto mt-6 p-2">
    <div class="flex space-x-2">
      ...
      <p class="text-green-900 font-semibold">The website looks awesome</p>
    </div>
    <p class="ml-8 text-green-800">Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem impedit possimus voluptatem dicta libero?</p>
  </div>
  <div class="w-screen max-w-lg bg-blue-200 mx-auto mt-6 p-2">
    <div class="flex space-x-2">
      ...
      <p class="text-blue-900 font-semibold">Blog design update needed</p>
    </div>
    <p class="ml-8 text-blue-800">Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem impedit possimus voluptatem dicta libero?</p>
  </div>
</div>
